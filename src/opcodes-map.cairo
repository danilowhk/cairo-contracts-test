...
// Opcode Lists based on https://github.com/dethcrypto/ethereumjs-vm/blob/master/lib/evm/opcodes.ts

// The idea is that these data would be used as input during construction of the contract.
